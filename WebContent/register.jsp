...
<body>
<h1><p align="center">Company Name</p></h1>
  ...
  <br><br><br>
  <div class="container">
<form class="w-25 mx-auto" method="post" action="InsertUser" enctype="multipart/form-data">
	
	      <!-- Username input -->
	      <div class="form-outline mb-4">
	        <input type="text" id="firstname" name="firstname" class="form-control" />
	        <label class="form-label" for="registerUsername">Firstname</label>
	      </div>
	
	      <!-- Email input -->
	      <div class="form-outline mb-4">
	        <input type="text" id="lastname" name="lastname" class="form-control" />
	        <label class="form-label" for="registerEmail">Lastname</label>
	      </div>
	  ...
	  <div class="form-outline mb-4">
	      ...
	      <div class="form-outline mb-4">
	        ...
	        <label class="form-label" for="registerPassword">Phone</label>
	      </div>
	 ...
	 <div class="form-outline mb-4">
	      ...
	      <div class="form-outline mb-4">
	        ...
	        <label class="form-label" for="registerPassword">Username</label>
	      </div>
