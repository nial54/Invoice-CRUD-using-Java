...
<%@ page import="com.mvc.controller.EditUser, com.mvc.controller.EditProduct, com.mvc.bean.Data "%>
...
<%
		...
		if(id==null || session.getAttribute("role").equals("admin"))
		{
			%>
  ...
  <%  
	...
	<h2 align="center">Status Data</h2>
		...
		<center><img src="getimage?id=<%=d.getId() %>&product=<%= product %>" width="100px"></center>
